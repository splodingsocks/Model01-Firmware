...
KEYMAPS(
    ...
    [PRIMARY] = KEYMAP_STACKED(Key_Escape, Key_1, Key_2, Key_3, Key_4, Key_5, Key_LEDEffectNext,
                               Key_Tab, Key_Q, Key_W, Key_E, Key_R, Key_T, Key_Backtick,
                               Key_LeftControl, Key_A, Key_S, Key_D, Key_F, Key_G,
                               Key_LeftShift, Key_Z, Key_X, Key_C, Key_V, Key_B, LSHIFT(Key_Backslash),
                               Key_Spacebar, Key_LeftGui, Key_PageDown, Key_PageUp,
                               ShiftToLayer(FUNCTION),

                               LSHIFT(Key_2), Key_6, Key_7, Key_8, Key_9, Key_0, Key_Minus,
                               LSHIFT(Key_5), Key_Y, Key_U, Key_I, Key_O, Key_P, Key_Equals,
                               Key_H, Key_J, Key_K, Key_L, Key_Semicolon, Key_Quote,
                               LSHIFT(LCTRL(Key_LeftGui)), Key_N, Key_M, Key_Comma, Key_Period, Key_Slash, Key_RightShift,
                               LCTRL(LSHIFT(Key_1)), Key_LeftAlt, Key_Enter, Key_Backspace,
                               ShiftToLayer(FUNCTION)),
...
#error "No default keymap defined. You should make sure that you have a line like '#define PRIMARY_KEYMAP_QWERTY' in your sketch"
    ...
    [FUNCTION] = KEYMAP_STACKED(___, Key_F1, Key_F2, Key_F3, Key_F4, Key_F5, ___,
                                ...
                                ___, ___, ___, Key_LeftParen, Key_RightParen, Key_Equals,
                                ___, ___, ___, ___, ___, ___, ___,
                                ___, ___, ___, ___,
                                ___,
